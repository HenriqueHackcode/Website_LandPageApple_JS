...
function trocarImagem() {
  const IdOpcaoSelicionada = document.querySelector(
    '[name="opcao-imagem"]:checked'
  ).id;
  imagemSelecionada = IdOpcaoSelicionada.charAt(0);
...
function trocarTamanho() {
  ...
  tamanhoSelecionado = IdOpcaoSelicionada.charAt(0);
...
function trocarCor() {
  ...
  corSelecionada = IdOpcaoSelicionada.charAt(0);
  tituloProduto.innerText =
    'Pulseira loop esportiva ' +
    opcoesCores[corSelecionada].nome +
    ' para caixa de ' +
